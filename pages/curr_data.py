...
def app(total_energy, location):
  ...
  print(type(total_energy['datetime']))
  return render_template('average_demand.html', title = 'Current Data for ' + location.title(), data = total_energy, times = total_energy["datetime"], values = total_energy["power"])
